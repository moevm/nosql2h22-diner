...
export const Payments: React.FC = () => {
  ...
  return (
    <div>
      ...
      <p> Price range: </p>
      <br/>
      <Slider onAfterChange={onSliderChanges} range defaultValue={[50, 250]} max={1000} style={{ width: 500 }}/>
      <br />
      <br />
      <List
        size="large"
        header={<div>Payments found: {paymentsList.data?.length ? paymentsList.data?.length : 0}</div>}
